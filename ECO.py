...
def new_win():
  # w.destroy()
    os.startfile("eco boost x10.html")
...
l1=Label(w,text='ECO BOOST',fg='white',bg=a)
lst1=('Calibri (Body)',18,'bold')
l1.config(font=lst1)
l1.place(x=50,y=80)

l2=Label(w,text='X10',fg='white',bg=a)
lst2=('Calibri (Body)',18)
l2.config(font=lst2)
l2.place(x=200,y=82)

l3=Label(w,text='CREATED BY MD.AZIZ',fg='white',bg=a)
